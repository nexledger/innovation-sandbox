...
This directory contains a sample __Fabric v1.4__ network with the following properties.

## Topology
* The network has 1 participating organizations.
* The network has 1 orderer node in solo mode.
* a organization has 2 peer in the network.
